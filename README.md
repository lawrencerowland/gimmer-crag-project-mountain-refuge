...
- [Boundary Contract Lab](apps/boundary-contract-lab/) composes finite open method fragments while preserving resource ownership and jointly enabled steps. It compares enriched contracts with direct source-net gluing and exposes failures of closed summaries, fabricated supply and whole-fragment barriers. Its front-page orientation connects Ends/Ways/Means to the source papers; live Petri-net, boundary-joining and monoidal-arrow views make those methods visible in the checked example. [Method and source uses](planning/boundary-contract-method.html); [build and independent challenge](planning/boundary-contract-run-2026-09-19.md).
